...
class QuotationService 
{
    ...
    function updateQuotation(Request $request)  {
        ...
        if ($quotation === 'internet') { // Use === for strict comparison
            return view('cmt-opportunity.quotation.pages.create-internet-quotation', compact('dataQuotation'));
        } 
        if ($quotation === 'perangkat') { // Use === for strict comparison
            return view('cmt-opportunity.quotation.pages.create-perangkat-quotation', compact('dataQuotation'));
        } 
    }
