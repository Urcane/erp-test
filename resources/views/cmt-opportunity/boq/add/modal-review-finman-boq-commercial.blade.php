<div class="modal fade" id="kt_modal_review_finman_boq_commercial" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body mx-5 mx-lg-15">
                <form id="kt_modal_review_finman_boq_commercial_form"
                    class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-6">
                        <div class="scroll-y me-n10 pe-10" id="kt_modal_review_finman_boq_commercial_scroll"
                            data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}"
                            data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#kt_modal_review_finman_boq_commercial_header"
                            data-kt-scroll-wrappers="#kt_modal_review_finman_boq_commercial_scroll"
                    ...
                    <div class="text-center row mb-12">
                        <textarea class="form-control form-control-solid" id="remark_finman" value="" placeholder=""
                            rows="2" style="resize:none"></textarea>
                    </div>

                    <div class="text-center row mb-12">
                        <button type="button" id="kt_modal_review_finman_boq_commercial_approve"
                            class="col-lg-5 btn btn-sm btn-info h-36px my-3 me-3">
                            <span class="indicator-label">Approve</span>
                        </button>
                        <button type="button" id="kt_modal_review_finman_boq_commercial_decline"
                            class="col-lg-4 btn btn-sm btn-danger h-36px my-3 me-3">
                            <span class="indicator-label">Decline</span>
                        </button>
                        <button type="reset" id="kt_modal_review_finman_boq_commercial_cancel"
