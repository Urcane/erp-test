                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="tab_survey_content" role="tabpanel">
                                        <div class="row">
                                           <div class="table-responsive">
                                            <div class="col-lg-12">
                                                <table class="table align-top table-striped border table-rounded gy-5" id="kt_table_survey">
                                                    <thead class="">
                                    ...
                                    <div class="tab-pane fade" id="tab_commercial_content" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="table-responsive">
                                                    <table class="table align-top table-striped border table-rounded gy-5" id="kt_table_commercial">
                                                        <thead class="">
                                                            <tr class="fw-bold fs-7 text-gray-500 text-uppercase">
                                                                <th class="text-center w-25px">#</th>
                                                                <th class="w-25px">#</th>
                                    ...
                                    <div class="tab-pane fade" id="tab_boq_done_content" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="table-responsive">
                                                    <table class="table align-top table-striped border table-rounded gy-5" id="kt_table_boq-done">
                                                        <thead class="">
                                                            <tr class="fw-bold fs-7 text-gray-500 text-uppercase">
                                                                <th class="text-center w-25px">#</th>
                                                                <th class="w-25px">#</th>
                                                                    ...
                                                                    <div class="timeline">
                                                                        <div class="timeline">
                                                                            <div class="timeline-item">
                                                                              ...
                                                                              <div class="timeline-content">
                                                                                <div class="pe-5">
                                                                                  <span class="fw-bold d-block">Done</span>
                                                                                  <p class="text-gray-500 mb-0">Updated: 13 Mei 2023</p>
                                                                                </div>
                                                                              </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="timeline">
                                                                        <div class="timeline">
                                                                            <div class="timeline-item">
                                                                              ...
                                                                              <div class="timeline-content">
                                                                                <div class="pe-5">
                                                                                  <span class="fw-bold d-block">Canceled</span>
                                                                                  <p class="text-gray-500 mb-0">Updated: 13 Mei 2023</p>
                                                                                </div>
                                                                              </div>
                                                                            </div>
