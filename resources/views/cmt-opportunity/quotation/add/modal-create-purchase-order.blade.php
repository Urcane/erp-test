    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header pb-0 border-0 justify-content-end">
                <div>
                    <span class="badge badge-light-warning fs-6" id="countable_purchase_order_items">1</span>
                </div>
                ...
                <form id="kt_modal_create_purchase_order_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
                    ...
                    <div class="row mb-9">
                        <div class="col-lg-12 text-center mb-9">
                            ...
                            <span class="fs-7 fw-semibold text-gray-500">Apa ada yakin ingin <b class="text-primary">menambahkan purchase order</b> pada Quotation ini<span id="prospect_name"></span> ?</span>
                        </div>
                        ...
                        <div class="col-lg-10 mb-3">
							<button type="button" class="btn btn-sm btn-outline btn-active-light-info w-lg-150px btn_add_more_purchase_order_item"><i class="fa-solid fa-plus"></i>Tambah Item</button>
						</div>
                    ...
                    <div class="text-center mt-9">
                        <button type="reset" id="kt_modal_create_purchase_order_cancel" class="btn btn-sm btn-light me-3 w-lg-200px" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" id="kt_modal_create_purchase_order_submit" class="btn btn-sm btn-info w-lg-200px">
