...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <div
                                        ...
                                        <div class="my-8 d-flex justify-content-around flex-wrap col-12">
                                            ...
                                            <div class="col-lg-2 col-8 col-sm-2 col-md-2 ">
                                                ...
                                                <input type="text" class="form-control form-control-solid" disabled
                                                    placeholder="{{ $dataBoq['dataCompanyItem'][0]->boq_type }}">
                                                <input type="hidden" class="form-control form-control-solid" disabled
                                                    name="boq_type" id="boq_type"
                                                    value="{{ $dataBoq['dataCompanyItem'][0]->boq_type }}">
                                                <div id="error-prospect"></div> 
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="row d-flex justify-content-between ">
                                                            ...
                                                            <div class="col-12 col-lg-3 col-md-6">
                                                                <div
                                                                    ...
                                                                    <div class="@if($dataBoq['dataCompanyItem'][0]->boq_type == "perangkat") col-lg-5 col-md-5 col-5 col-sm-5 @else col-lg-10 col-md-10 col-10 col-sm-10 @endif">
                                                                    ...
                                                                    @if($dataBoq['dataCompanyItem'][0]->boq_type == "perangkat")
                                ...
                                <form id="kt_create_quotation_internet_form"
                                    ...
                                    @if ($dataBoq['dataCompanyItem'][0]->boq_type == "internet")
    ...
    <script>
        ...
        function updateTotalSumBundle() {
            ...
            $('.BundleItem input[name^="total_price_"]').each(function() {
