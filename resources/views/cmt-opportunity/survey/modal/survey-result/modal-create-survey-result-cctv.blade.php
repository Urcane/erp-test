<div class="modal fade" id="kt_modal_create_survey_result_cctv" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-5 mx-lg-15 my-7">
                <form id="kt_modal_create_survey_result_cctv_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
                    ...
                    <div class="scroll-y me-n10 pe-10" id="kt_modal_create_survey_result_cctv_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_create_survey_result_cctv_header" data-kt-scroll-wrappers="#kt_modal_create_survey_result_cctv_scroll" data-kt-scroll-offset="300px">
                        <div class="row mb-9">
                            <div class="col-lg-12 text-center mb-9">
                                <i class="fas fa-file-signature text-primary fs-3x mb-6"></i>
                                <span class="fs-1 fw-bolder text-dark d-block mb-1">Membuat Hasil Survey CCTV</span>
                            ...
                            <div class="stepper stepper-pills kt_stepper_survey_result_cctv">
                                ...
                                <div class="w-lg-500px mx-auto">
                                    <div class="mb-10">
                                        <div class="flex-column current" data-kt-stepper-element="content">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-lg-6 mb-3">
                                                            <input type="checkbox" class="form-check-input checkbox-real" placeholder="" name="building_rooftop_state" id="building_rooftop_state" value="0">
                                                        ...
                                                        <div class="col-lg-6 mb-3">
                                                            <input type="checkbox" class="form-check-input checkbox-real" placeholder="" name="building_electricity_state" id="building_electricity_state" value="0">
                                                ...
                                                <div class="col-lg-4 mb-3">
                                                    ...
                                                    <select class="drop-data form-select form-select-solid" data-control="select2" name="building_electricity_type" data-dropdown-parent="#kt_modal_create_survey_result_cctv">
                                                        <option value="" selected hidden disabled>Pilih Dulu</option>
                                        ...
                                        <div class="flex-column" data-kt-stepper-element="content">
                                            <div class="row">
                                                <div class="col-lg-12 mb-3">
                                                    <label class="d-flex align-items-center fs-6 form-label mb-2">
                                                        <span class="require fw-bold">Jenis Kamera</span>
                                                    </label>
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <label class="d-flex align-items-center fs-6 form-label mb-2">
                                                        <span class="required fw-bold">Potensi Jumlah CCTV</span>
                                                    </label>
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <label class="d-flex align-items-center fs-6 form-label mb-2">
                                                        <span class="required fw-bold">Record Duration</span>
                                                    </label>
                                                    <input type="text" class="form-control form-control-solid" placeholder="" required name="record_duration">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                                <div class="col-lg-6 mb-3">
                                                    <label class="d-flex align-items-center fs-6 form-label mb-2">
                                                        <span class="required fw-bold">Camera Storage</span>
                                                    </label>
                                                    <input type="text" class="form-control form-control-solid" placeholder="" required name="camera_storage">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                                <div class="col-lg-6 mb-3">
                                                    <label class="d-flex align-items-center fs-6 form-label mb-2">
                                                        <span class="required fw-bold">Camera Resolution</span>
                                                    </label>
                                                    <input type="text" class="form-control form-control-solid" placeholder="" required name="camera_resolution">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                                <div class="col-lg-12 mb-3">
                                                    <label class="d-flex align-items-center fs-6 form-label mb-2">
                                    ...
                                    <div class="mt-6 d-flex flex-stack">
                                        ...
                                        <div>
                                            <button type="submit" id="kt_modal_create_survey_result_cctv_submit" class="btn btn-sm btn-info w-lg-200px" data-kt-stepper-action="submit">
