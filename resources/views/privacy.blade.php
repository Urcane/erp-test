...
<body>
    <h1>Privacy Policy for Comtelindo ERP</h1>

    <p>This Privacy Policy Include :</p>
    ...
    <p>At Comtelindo ERP, accessible from https://erp.comtelindo.com/, one of our main priorities is the privacy of our
        ...
        Comtelindo ERP and how we use it.</p>
    ...
    <p>Comtelindo ERP follows a standard procedure of using log files. These files log visitors when they visit
    ...
    <p>Like any other website, Comtelindo ERP uses "cookies". These cookies are used to store information including
    ...
    <P>You may consult this list to find the Privacy Policy for each of the advertising partners of Comtelindo ERP.</p>

    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
        their respective advertisements and links that appear on Comtelindo ERP, which are sent directly to users'
    ...
    <p>Note that Comtelindo ERP has no access to or control over these cookies that are used by third-party advertisers.
    </p>

    <h2>Third Party Privacy Policies</h2>

    <p>Comtelindo ERP's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
    ...
    <p>Comtelindo ERP does not knowingly collect any Personal Identifiable Information from children under the age of
    ...
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
        to the information that they shared and/or collect in Comtelindo ERP. This policy is not applicable to any
