				...
				<form id="kt_modal_tambah_karyawan_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
					...
					<div class="row mb-10">
						...
						<div class="col-lg-4 mb-6">
							...
							<input type="number" class="form-control form-control-solidd" placeholder="" required name="nip">
							<div class="fv-plugins-message-container invalid-feedback"></div>
						</div>
						<div class="col-lg-6 mb-6">
							...
							<input type="number" class="form-control form-control-solidd" placeholder="" required name="nik">
							<div class="fv-plugins-message-container invalid-feedback"></div>
						</div>
						<div class="col-lg-6 mb-6">
							<label class="d-flex align-items-center fs-6 form-label mb-2">
							...
							<div class="input-group mb-5">
								...
								<input type="number" class="form-control form-control-solidd" required name="kontak"/>
							</div>
							<div class="fv-plugins-message-container invalid-feedback"></div>
						</div>
						<div class="col-lg-6 mb-6">
							...
							<select class="drop-data form-select form-select-solidd" data-control="select2" required name="division_id" id="division_id" data-dropdown-parent="#kt_modal_tambah_karyawan" tabindex="-1">
						...
						<div class="col-lg-6 mb-6">
							...
							<select class="drop-data form-select form-select-solidd" data-control="select2" required name="team_id" id="team_id" data-dropdown-parent="#kt_modal_tambah_karyawan" tabindex="-1">
								<option value="" selected hidden disabled>Pilih Dulu</option>
						...
						<div class="col-lg-8 mb-6">
							...
							<input type="email" class="form-control form-control-solidd" placeholder="" required name="email">
							<div class="fv-plugins-message-container invalid-feedback"></div>
						</div>
						<div class="col-lg-4 mb-6">
							<label class="d-flex align-items-center fs-6 form-label mb-2">
							...
							<select class="drop-data form-select form-select-solidd" data-control="select2" required name="role_id" id="role_id" data-dropdown-parent="#kt_modal_tambah_karyawan" tabindex="-1">
								<option value="" selected hidden disabled>Pilih Dulu</option>
						...
						<div class="col-lg-6 mb-6">
							...
							<input type="password" class="form-control form-control-solidd" placeholder="" confirmed required minlength="8" name="new_password">
							<div class="fv-plugins-message-container invalid-feedback"></div>
						</div>
						<div class="col-lg-6 mb-6">
							<label class="d-flex align-items-center fs-6 form-label mb-2">
							...
							<input type="password" class="form-control form-control-solidd" placeholder="" required minlength="8" name="new_password_confirmation">
							<div class="fv-plugins-message-container invalid-feedback"></div>
						</div>
						<div class="col-lg-12 mb-6">
							<div class="notice align-items-center d-flex bg-light-info rounded border-info border border-dashed p-6">
								<i class="fa-solid fa-exclamation-circle fs-1 me-4 text-info"></i>
