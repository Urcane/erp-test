<div class="modal fade" id="shift_info_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body mx-2 mb-2">
                ...
                <div class="scroll-y me-n6 pe-6" data-kt-scroll="true"
                    ...
                    <div class="row p-2 m-1 rounded border border-2 border-secondary">
                        <div class="col-lg-2 mb-1">
                            <span class="fs-8 text-gray-600 fw-semibold mb-1" id="shf-title-prm-shift-modal">Current
                                Shift</span>
                            <p class="fs-7 fw-normal" id="shf-prm-shift-modal">-</p>
                        </div>
                        <div class="col-lg-3 mb-1">
                            <span class="fs-8 text-gray-600 fw-semibold mb-1" id="shf-title-prm-work-modal">Current
                                Work
                                Hours</span>
                    ...
                    <p class="fw-bold mt-4" id="att_shift_label">Comment</p>
                    <textarea id="shift_comment" class="form-control form-control-solid" placeholder="-"></textarea>
                </div>
                ...
                <div class="text-center mt-9" id="shift_cancel_button">
                    <button type="reset" id="shift_cancel" class="btn btn-outline btn-outline-danger btn-sm me-3"
                        data-bs-dismiss="modal">
                        <i class="fas fa-times text-danger"></i>
                        Cancel Request
                    </button>
                </div>
                <div class="text-center mt-9" id="shift_canceled_button">
