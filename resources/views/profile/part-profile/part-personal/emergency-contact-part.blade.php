        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body mx-5 mx-lg-15 mb-7">
                    <form id="modal_create_emergency_contact_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="user_id" value="{{ $user->id }}">
                        <input type="hidden" name="id" value="">
                        <div class="scroll-y me-n10 pe-10" id="modal_create_emergency_contact_scroll" data-kt-scroll="true"
                            data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#modal_create_emergency_contact_header"
                            data-kt-scroll-wrappers="#modal_create_emergency_contact_scroll" data-kt-scroll-offset="300px">
                            <div class="row mb-9">
                                <div class="col-lg-12 text-center mb-9">
                                    <span class="fs-1 fw-bolder text-dark d-block mb-1">Emergency Contact</span>
                                    <span class="fs-7 fw-semibold text-gray-500">Nomor yang dapat dihubungi dalam keadaan
                                        darurat</span>
                                </div>
                                ...
                                <div class="col-lg-12 mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-solid"
                                        placeholder="Nomor yang dapat dihubungi" required name="phone">
                                </div>
                        ...
                        <div class="text-center mt-9">
                            <button type="reset" id="modal_create_emergency_contact_cancel"
                                class="btn btn-sm btn-light me-3 w-lg-200px" data-bs-dismiss="modal">Cancel</button>
                            <button type="submit" id="modal_create_emergency_contact_submit"
...
@can('HC:update-profile')
    <div class="col-lg-6 d-flex justify-content-end">
        <div>
            <a href="#modal_create_emergency_contact" data-bs-toggle="modal"
                class="btn btn-info btn-sm me-3 btn_tambah_contact"><i class="fa-solid fa-plus"></i>Add Emergency
                Contact</a>
        </div>
    </div>
@endcan
