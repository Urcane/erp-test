    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body mx-5 mx-lg-15 mb-7">
                <form id="modal_create_non_formal_education_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="user_id" value="{{$user->id}}">
                    <input type="hidden" name="id" value="">
                    <div class="scroll-y me-n10 pe-10" id="modal_create_non_formal_education_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#modal_create_non_formal_education_header" data-kt-scroll-wrappers="#modal_create_non_formal_education_scroll" data-kt-scroll-offset="300px">
                    <div class="row mb-9">
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Program Diselenggarakan Oleh" required name="held_by">
						</div>
                        <div class="col-lg-12 mb-3">
                            <label class="d-flex align-items-center fs-6 form-label mb-2">
                                <span class="fw-bold">Expired Date (kosongkan jika tidak ada tanggal kadaluarsa)</span>
                            </label>
                            <input type="date" class="form-control form-control-solid" placeholder="Tanggal Kadaluarsa" name="expired_date">
                        </div>
                        <div class="col-lg-12 mb-3">
							<label class="d-flex align-items-center fs-6 form-label mb-2">
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <input type="number" class="form-control form-control-solid" placeholder="Berapa hari kegiatan berlangsung" required name="duration">
						</div>
                        <div class="col-lg-12 mb-3">
							<label class="d-flex align-items-center fs-6 form-label mb-2">
								<span class="required fw-bold">Fee</span>
							</label>
                            <input type="number" class="form-control form-control-solid" placeholder="Bayaran yang perlu dikerluarkan" required name="fee">
						</div>
                        <div class="col-lg-12 mb-3">
							<label class="d-flex align-items-center fs-6 form-label mb-2">
                    ...
                    <div class="text-center mt-9">
                        <button type="reset" id="modal_create_non_formal_education_cancel" class="btn btn-sm btn-light me-3 w-lg-200px" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" id="modal_create_non_formal_education_submit" class="btn btn-sm btn-info w-lg-200px">
...
<div class="col-lg-6 d-flex justify-content-end mt-9">
    <div>
        <a href="#modal_create_non_formal_education" data-bs-toggle="modal" class="btn btn-info btn-sm me-3 btn_tambah_formal"><i class="fa-solid fa-plus"></i>Add Non Formal Education</a>
    </div>
</div>
<div class="col-lg-12">
...
<script>
    ...
    $( "#education_experience" ).on( "click", function() {
        dataTable = $('#tb_non_formal_education_content').DataTable({
            processing: true,
            serverSide: true,
            retrieve: true,
            deferRender: true,
