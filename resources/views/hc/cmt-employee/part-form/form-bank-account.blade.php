<section class="row">
    ...
    <div class="col-lg-12 mb-3">
        ...
        <select class="drop-data form-select form-select-solid" data-control="bank_name" name="bank_name" id="bank_name" @cannot("HC:update-profile") disabled @endcannot>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <input type="number" value="{{$user->userBank->number ?? old('bank_number')}}" class="form-control form-control-solid" placeholder="Nomor rekening" name="bank_number" id="bank_number" @cannot("HC:update-profile") disabled @endcannot>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
    <div class="col-lg-6 mb-3">
        ...
        <input type="text" value="{{$user->userBank->holder_name ?? old('bank_holder_name')}}" class="form-control form-control-solid" placeholder="Pemilik rekening" name="bank_holder_name" id="bank_holder_name" @cannot("HC:update-profile") disabled @endcannot>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
</section>
