<section class="row">
    ...
    <div class="col-lg-6 mb-3">
        ...
        <input type="number" value="{{$user->userBpjs->ketenagakerjaan_number ?? old('ketenagakerjaan_number')}}" class="form-control form-control-solid" placeholder="BPJS Ketenagakerjaan Number" name="ketenagakerjaan_number" id="ketenagakerjaan_number" @cannot("HC:update-profile") disabled @endcannot>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <select class="drop-data form-select form-select-solid" data-control="ketenagakerjaan_npp" name="ketenagakerjaan_npp" id="ketenagakerjaan_npp" @cannot("HC:update-profile") disabled @endcannot>
    ...
    <div class="col-lg-12 mb-3">
        ...
        <input type="date" value="{{$user->userBpjs->ketenagakerjaan_date ?? old('ketenagakerjaan_date')}}" class="form-control form-control-solid" placeholder="BPJS Ketenagakerjaan Date" name="ketenagakerjaan_date" id="ketenagakerjaan_date" @cannot("HC:update-profile") disabled @endcannot>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <input type="number" value="{{$user->userBpjs->kesehatan_number ?? old('kesehatan_number')}}" class="form-control form-control-solid" placeholder="BPJS Kesehatan Number" name="kesehatan_number" id="kesehatan_number" @cannot("HC:update-profile") disabled @endcannot>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
    <div class="col-lg-6 mb-3">
        ...
        <select class="drop-data form-select form-select-solid" data-control="kesehatan_family" name="kesehatan_family" id="kesehatan_family" @cannot("HC:update-profile") disabled @endcannot>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <input type="date" value="{{$user->userBpjs->kesehatan_date ?? old('kesehatan_date')}}" class="form-control form-control-solid" placeholder="BPJS Kesehatan Date" name="kesehatan_date" id="kesehatan_date" @cannot("HC:update-profile") disabled @endcannot>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
    <div class="col-lg-6 mb-3">
        ...
        <select class="drop-data form-select form-select-solid" data-control="kesehatan_cost" name="kesehatan_cost" id="kesehatan_cost" @cannot("HC:update-profile") disabled @endcannot>
    ...
    <div class="col-lg-12 mb-3">
        ...
        <select class="drop-data form-select form-select-solid" data-control="jht_cost" name="jht_cost" id="jht_cost" @cannot("HC:update-profile") disabled @endcannot>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <select class="drop-data form-select form-select-solid" data-control="jaminan_pensiun_cost" name="jaminan_pensiun_cost" id="jaminan_pensiun_cost" @cannot("HC:update-profile") disabled @endcannot>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <input type="date" value="{{$user->userBpjs->jaminan_pensiun_date ?? old('jaminan_pensiun_date')}}" class="form-control form-control-solid" placeholder="Jaminan Pensiun Date" name="jaminan_pensiun_date" id="jaminan_pensiun_date" @cannot("HC:update-profile") disabled @endcannot>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
</section>
