<section class="row">
    ...
    <div class="col-lg-6 mb-3">
        ...
        <input type="text" pattern="[0-9]{2}.[0-9]{3}.[0-9]{3}.[0-9]{1}-[0-9]{3}.[0-9]{3}" class="form-control form-control-solid" placeholder="00.000.000.0-000.000" name="npwp" id="npwp" @unlessrole("administrator") disabled @endunlessrole>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <input type="date" class="form-control form-control-solid" placeholder="Select Date" name="taxable_date" id="taxable_date" @unlessrole("administrator") disabled @endunlessrole>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
    <div class="col-lg-6 mb-3">
        <label class="d-flex align-items-center fs-6 form-label mb-2" for="ptkp_status">
    ...
    <div class="col-lg-6">
        ...
        <div class="input-group mb-3">
            ...
            <input type="number" class="form-control form-control-solid" placeholder="0" name="beginning_netto" id="beginning_netto" @unlessrole("administrator") disabled @endunlessrole>
        </div>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
    <div class="col-lg-6">
        ...
        <div class="input-group mb-3">
            ...
            <input type="number" class="form-control form-control-solid" placeholder="0" name="pph21_paid" id="pph21_paid" @unlessrole("administrator") disabled @endunlessrole>
        </div>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
</section>
