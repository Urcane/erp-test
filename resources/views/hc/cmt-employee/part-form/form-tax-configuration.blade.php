...
<section class="row">
    ...
    <div class="col-lg-6 mb-3">
        ...
        <input type="text" value="{{$user->userTax->npwp ?? old('npwp')}}" class="form-control form-control-solid" placeholder="00.000.000.0-000.000" name="npwp" id="npwp" @cannot("HC:update-profile") disabled @endcannot>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <select class="drop-data form-select form-select-solid" data-control="pktp" required name="pktp" id="pktp" @cannot("HC:update-profile") disabled @endcannot>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <select class="drop-data form-select form-select-solid" data-control="tax_method" name="tax_method" id="tax_method" @cannot("HC:update-profile") disabled @endcannot>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <select class="drop-data form-select form-select-solid" data-control="tax_salary" name="tax_salary" id="tax_salary" @cannot("HC:update-profile") disabled @endcannot>
    ...
    <div class="col-lg-6 mb-3">
        ...
        <input type="date" value="{{$user->userTax->taxable_date ?? old('taxable_date')}}" class="form-control form-control-solid" placeholder="Select Date" name="taxable_date" id="taxable_date" @cannot("HC:update-profile") disabled @endcannot>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
    <div class="col-lg-6 mb-3">
        ...
        <select class="drop-data form-select form-select-solid" data-control="tax_status_id" name="tax_status_id" id="tax_status_id" @cannot("HC:update-profile") disabled @endcannot>
            @foreach ($dataTaxStatus as $option)
                <option value="{{$option->id}}" @if ($user->userTax->tax_status_id ?? old('tax_status_id') == $option->id) selected @endif>{{$option->name}}</option>
            @endforeach
        </select>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
    ...
    <div class="col-lg-6">
        ...
        <div class="input-group mb-3">
            ...
            <input type="number" value="{{$user->userTax->beginning_netto ?? old('beginning_netto')}}" class="form-control form-control-solid" placeholder="0" name="beginning_netto" id="beginning_netto" @cannot("HC:update-profile") disabled @endcannot>
        </div>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
    <div class="col-lg-6">
        ...
        <div class="input-group mb-3">
            ...
            <input type="number" value="{{$user->userTax->pph21_paid ?? old('pph21_paid')}}" class="form-control form-control-solid" placeholder="0" name="pph21_paid" id="pph21_paid" @cannot("HC:update-profile") disabled @endcannot>
        </div>
        <div class="fv-plugins-message-container invalid-feedback"></div>
    </div>
</section>
