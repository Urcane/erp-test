@include('hc.cmt-request.timeoff.modal')
...
<div class="row border rounded p-4 mb-4 justify-content-center">
    <div class="col-6">
        <p class="fw-bold fs-6 mb-2" id="view-date-timeoff">View Date : -</p>
        <div class="ms-1 row">
            <div class="col summaries" href="#summaries_modal" data-bs-toggle="modal" data-param="on-time">
                <div class="text-info fw-bolder fs-4 mb-3" id="view-need-tmoff">-</div>
            ...
            <div class="col summaries" href="#summaries_modal" data-bs-toggle="modal" data-param="late-clock-in">
                <div class="text-info fw-bolder fs-4 mb-3" id="view-approved-tmoff">-</div>
            ...
            <div class="col summaries" href="#summaries_modal" data-bs-toggle="modal" data-param="early-clock-out">
                <div class="text-info fw-bolder fs-4 mb-3" id="view-reject-tmoff">-</div>
    ...
    <div class="col-6">
        ...
        <div class="ms-1 row">
            <div class="col summaries" href="#summaries_modal" data-bs-toggle="modal" data-param="on-time">
                <div class="text-info fw-bolder fs-4 mb-3" id="all-need-tmoff">-</div>
                <div class="fw-semibold fs-7 text-gray-600">Need Approval</div>
            </div>
            <div class="col summaries" href="#summaries_modal" data-bs-toggle="modal" data-param="late-clock-in">
                <div class="text-info fw-bolder fs-4 mb-3" id="all-approved-tmoff">-</div>
                <div class="fw-semibold fs-7 text-gray-600">Approved</div>
            </div>
            <div class="col summaries" href="#summaries_modal" data-bs-toggle="modal" data-param="early-clock-out">
                <div class="text-info fw-bolder fs-4 mb-3" id="all-reject-tmoff">-</div>
                <div class="fw-semibold fs-7 text-gray-600">Rejected</div>
            </div>
        </div>
    </div>
...
<div class="d-flex justify-content-end mb-2">
    <div class="input-group w-150px w-md-250px mx-4">
        ...
        <input class="form-control form-control-solid form-control-sm" autocomplete="off" id="search_timeoff">
    </div>

    <div class="input-group w-150px w-md-250px mx-4">
        <span class="input-group-text border-0"><i class="fa-solid fa-calendar"></i></span>
        <input class="form-control form-control-solid form-control-sm" autocomplete="off" name="range_date_timeoff"
            id="range_date_timeoff">
    </div>
    ...
    <div>
        ...
        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px text-start" id="filter_pegawai_timeoff"
            ...
            <div class="row px-8 pb-6">
                <div class="col-lg-12 mb-3">
                    ...
                    <select class="form-select form-select-sm form-select-solid" data-control="select2" required
                        name="filterDepartment" id="filter_department_timeoff" data-dropdown-parent="#filter_pegawai_timeoff">
                ...
                <div class="col-lg-12 mb-3">
                    ...
                    <select class="form-select form-select-sm form-select-solid" data-control="select2" required
                        name="filterDivisi" id="filter_divisi_timeoff" data-dropdown-parent="#filter_pegawai_timeoff">
                ...
                <div class="col-lg-12 mb-3">
                    ...
                    <select class="form-select form-select-sm form-select-solid" data-control="select2" required
                        name="filterStatus" id="filter_status_timeoff" data-dropdown-parent="#filter_pegawai_timeoff">
...
<div class="row">
    <div class="col-lg-12">
        <table class="table align-top border table-rounded gy-5" id="kt_table_timeoff">
            <thead class="">
                <tr class="fw-bold fs-7 text-gray-500 text-uppercase overflow-y-auto">
                    ...
                    <th class="w-300px">Request Created</th>
