<script>
    ...
    $(document).ready(function() {
        $('input[name="range_date_attendance"]').daterangepicker({autoUpdateInput: false}, (from_date, to_date) => {
            $('#range_date_attendance').val(from_date.format('MM/DD/YYYY') + ' - ' + to_date.format('MM/DD/YYYY'));
        });
        ...
        .DataTable({
            ...
            columns: [
                ...
                { data: 'organization' , orderable: false, searchable: false},
                { data: 'job_level' , orderable: false, searchable: false},
                { data: 'job_position' , orderable: false, searchable: false},
