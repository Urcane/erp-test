        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body mx-5 mx-lg-15 mb-7">
                    <form id="modal_create_job_level_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                        ...
                        <div class="text-center mt-9">
                            <button type="reset" id="modal_create_job_level_cancel"
                                class="btn btn-sm btn-light me-3 w-lg-200px" data-bs-dismiss="modal">Cancel</button>
                            <button type="submit" id="modal_create_job_level_submit"
    ...
    $('#modal_create_job_level_form').submit(function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#modal_create_job_level').modal('hide');
