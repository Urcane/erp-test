...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 d-flex justify-content-end">
                                    <div>
                                        <a href="{{ route('hc.setting.branch.create') }}"
                                            class="btn btn-info btn-sm me-3 btn_tambah_pegawai"><i
    ...
    @include('components.delete-confirmation', ["id" => "Branch", "route" => route('hc.setting.branch.delete')])
